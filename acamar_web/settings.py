...
CMS_PLACEHOLDER_CONF = {
    ...
    "course_content": {
        "plugins": ["CreateTeamPlugin", "CourseBonusPanelPlugin", "CourseProgramPlugin", "CoursePanelPlugin", "CourseTermListPlugin", "CourseGenericRegistrationPlugin", "ContactPersonPlugin"],

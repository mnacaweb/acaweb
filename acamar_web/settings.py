...
CMS_PLACEHOLDER_CONF = {
    ...
    "we_are": {
        "plugins": ["CreateTeamPlugin", "TeamGridPlugin", "LogoPanelPlugin","TimelinePlugin","BlockLinksPlugin",],
        "name": "Content - we are",
    },
    "contact": {
        "plugins": ["ContactGridPlugin", "ContactFormPlugin", "MapPlugin","TimelinePlugin","BlockLinksPlugin",],
    ...
    "a-card": {
        "plugins": ["AcardBenefitsPlugin", "LoginPlugin","TimelinePlugin","BlockLinksPlugin",],
        "name": "Content A-card",
    },
    "course_content": {
        "plugins": [
    ...
    "enroll_in_course": {
        "plugins": ["CourseEnrollFormPlugin", "TimelinePlugin","BlockLinksPlugin",],
        "name": "Content - enroll in course",
        "limits": {"CourseEnrollFormPlugin": 1, "TimelinePlugin": 1},
    },
    "thank_you": {
        "plugins": ["ThanksBannerPlugin","BlockLinksPlugin",],

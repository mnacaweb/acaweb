...
urlpatterns = [
    ...
    path(
        "position_search/",
        PositionSearchAutocompleteApi.as_view(),
        name="position-search-autocomplete",
    ),
    path(
        "position_search/<int:id>/", PositionSearchApi.as_view(), name="position-search"
    ),
